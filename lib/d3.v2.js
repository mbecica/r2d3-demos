(function() {
  ...
  var d3_formatPrefixes = _([ "y", "z", "a", "f", "p", "n", "μ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y" ]).map(d3_formatPrefix);
  ...
  var d3_time_days = d3_time_daySymbols, d3_time_dayAbbreviations = d3.map(d3_time_days, d3_time_formatAbbreviate), d3_time_months = [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ], d3_time_monthAbbreviations = d3_time_months.map(d3_time_formatAbbreviate);
  ...
  function d3_time_formatRe(names) {
    return new RegExp("^(?:" + _(names).map(d3.requote).join("|") + ")", "i");
  }
